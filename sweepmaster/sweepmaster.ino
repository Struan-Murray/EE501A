...
void turn_angle(int a);
void turn_angleL(int a);
void turn_angleR(int a);
...
void turn_angle(int a)
{
	if(a < 0)turn_angleL(-a);
	else if(a > 0)turn_angleR(a);
	else{return;}
}

void turn_angleL(int a){ //Left
